...
MARKETS = [
    ...
    {"symbol": "DX-Y.NYB", "name": "Dolar Index"},
    ...
    for market in MARKETS:
        ...
        if vol_ratio >= SPIKE_THRESHOLD:
            ...
            if key not in alerts_sent:
                ...
                msg += "Vol ratio: " + str(round(vol_ratio, 1)) + "x\n"
                ...
                msg += ai + "\n"
                msg += "---\n"
                msg += "Edukativna simulacija! FuturesScout"
                send_whatsapp(msg)
        time.sleep(1)
...
def main():
    ...
    send_whatsapp("FuturesScout aktivan! AI analiza ukljucena. Pratim 10 trzista.")
    while True:
        try:
            check_markets()
        except Exception as e:
